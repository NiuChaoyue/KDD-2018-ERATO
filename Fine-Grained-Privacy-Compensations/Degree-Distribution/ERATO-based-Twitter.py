...
@Application: Degree Distribution (Twitter)
@Author: Chaoyue Niu
...
if __name__=="__main__":
    ...
    """
    Load Twitter_Deg_Count
    index i, degree i + 1
    """
    DegCount = np.zeros((maxDegree, 1), int)
    numDataOwners = 0
    f1 = open("Twitter_Deg_Count")
    ...
    np.savetxt('Twitter_TD_MicroPayCount', TDMicroPayCount, fmt="%d")
    ...
    np.savetxt('Twitter_BU_MicroPayCount', BUMicroPayCount, fmt="%d")
